...
""" AES-256-CBC.py.
    AES CBC (Cipher Blocking Chaining) Tool using Default-Padding Code
    UWB Division of Computing and Software Systems
    CSS 337 Secure Systems—Winter 2016
    Mariana Chagoyan
    Encryption Tool – Initialization Vector (IV) from → AES 256

    Description:
    Generates a random initialization vector (IV) from a cryptographically
    random source with size  equal to the block size of AES-256 encryption.
    It also encrypts your input message using 
    a) AES 256, 
    b) IV 
    c) Ke 
    d) Chaining mode CBC 
